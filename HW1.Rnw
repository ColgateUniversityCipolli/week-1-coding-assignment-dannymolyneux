...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \textbf{Solution:}
<<FlamePlot1, eval=FALSE, echo=FALSE, size='scriptsize', warning=FALSE, message=FALSE>>=
set.seed(6)
canvas_flame(colors = colorPalette("kpd"),
          background = "#dbdbdb",
  iterations = 1000000,
  variations = 11,
  symmetry = -4,
...
\textbf{Solution:}
<<echo=FALSE>>=
Result.vector <- 2^(nums+1) + 2^(nums-1)
print(Result.vector)
@
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  % QUESTION 2c
