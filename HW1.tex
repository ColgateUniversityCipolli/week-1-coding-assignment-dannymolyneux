...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  update the caption.\\
\textbf{Solution:}
Yes, there are some small differences. The main one I notice is that this figure is shifted quite a bit to the right in relation to the previous figure.
\begin{knitrout}\scriptsize
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
...
\end{knitrout}
\caption{Collatz Conjecture with 1313 seed}
\label{CollatzPlot2}
\end{center}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\end{knitrout}
\caption{Vrolik4 Collatz Conjecture}
\label{CollatzPlot3}
\end{center}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{set.seed}\hldef{(}\hlnum{6}\hldef{)}
\hlkwd{canvas_flame}\hldef{(}\hlkwc{colors} \hldef{=} \hlkwd{colorPalette}\hldef{(}\hlsng{"kpd"}\hldef{),}
          \hlkwc{background} \hldef{=} \hlsng{"#dbdbdb"}\hldef{,}
  \hlkwc{iterations} \hldef{=} \hlnum{1000000}\hldef{,}
  \hlkwc{variations} \hldef{=} \hlnum{11}\hldef{,}
  \hlkwc{symmetry} \hldef{=} \hlopt{-}\hlnum{4}\hldef{,}
  ...
  \hlkwc{zoom} \hldef{=} \hlnum{1}\hldef{,}
  \hlkwc{resolution} \hldef{=} \hlnum{1000}\hldef{,}
  \hlkwc{gamma} \hldef{=} \hlnum{2}
\hldef{)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  the sentence below.
\textbf{Solution:} 
We created the generative art in Question 1 using the \texttt{aRtsy}package for \texttt{R} \citep{aRtsy}.
\end{enumerate}
...
\textbf{Solution:}
The which() function told us that the fifth element of the vector yields 40. The fifth element of our vector of integers is 4. 
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  % QUESTION 2e
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \item Explain why this approach wouldn't work for something like $3^{x+2} + 5 (3^x) = 84$ where the solution is $x \approx 1.6309$.\\
\textbf{Solution:}
This approach wouldn't work because our original vector is a vector of integers from 0 to 10. 1.6309 is not an integer, so we wouldn't even get 84 in our new vector that computes the algebraic equation.
\end{enumerate}
\end{enumerate}
